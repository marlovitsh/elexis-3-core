...
public class MarlovitsKontaktBlattExtension {
	...
	protected static Image getImageByName(String pluginid, String imageName){
	...
	protected static ImageDescriptor getImageDescriptorByName(String pluginid, String imageName){
		if (imageName == null || imageName.isEmpty()) {
			return null;
		}
		String path = imageName;
