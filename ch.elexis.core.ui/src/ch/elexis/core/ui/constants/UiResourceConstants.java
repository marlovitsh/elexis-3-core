...
/**
 * This class contains ID constants to be reference within the Eclipse UI. Each of the constants in
 * this class forms a contract to be fulfilled by any of the available plugins. That is, there has
 * to be respective instantiations on the given extension points available for all IDs for the
 * system to run.
 * 
 * @since 3.0.0
 */
